...
Source0  : https://infraroot.at/pub/mtd/mtd-utils-2.2.1.tar.bz2
Source1  : https://infraroot.at/pub/mtd/mtd-utils-2.2.1.tar.bz2.asc
...
%setup -q -n mtd-utils-2.2.1
cd %{_builddir}/mtd-utils-2.2.1
pushd ..
cp -a mtd-utils-2.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727475837
